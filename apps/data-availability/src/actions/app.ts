...
enum AppActions {
  ...
  FETCH_PRODUCT_BUNDLES = 'FETCH_PRODUCT_BUNDLES',
  FETCH_PRODUCT_BUNDLES_WORKING = 'FETCH_PRODUCT_BUNDLES_WORKING',
  FETCH_PRODUCT_BUNDLES_COMPLETED = 'FETCH_PRODUCT_BUNDLES_COMPLETED',
  FETCH_PRODUCT_BUNDLES_ERROR = 'FETCH_PRODUCT_BUNDLES_ERROR',
  RESET_FETCH_PRODUCT_BUNDLES = 'RESET_FETCH_PRODUCT_BUNDLES',
