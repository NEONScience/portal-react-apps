    ...
    <html lang="en">
      <head>
        ...
        <link
          ...
          href="/prototype-datasets/assets/css/drupal-fonts.css"
        />
        <link
          rel="stylesheet"
          data-meta="drupal-theme"
          href="/prototype-datasets/assets/css/drupal-theme.c12ee9878c2546595e186d8f3917da9c.min.css"
        />
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: 'window.gtmDataLayer = [{ page_category: "Prototype Data" }];',
          }}
        />
        <script
          dangerouslySetInnerHTML={{
