...
export const metadata: Metadata = {
  title: 'NEON | Explore Data Products',
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="manifest" href="/data-products/explore/manifest.json" />
        <link rel="shortcut icon" href="/data-products/explore/favicon.ico?v=201912" />
        <link rel="preconnect" href="https://www.neonscience.org" crossOrigin="anonymous" />
        <link
          rel="stylesheet"
          data-meta="drupal-fonts"
          href="/data-products/explore/assets/css/drupal-fonts.css"
        />
        <link
          rel="stylesheet"
          data-meta="drupal-theme"
          href="/data-products/explore/assets/css/drupal-theme.c12ee9878c2546595e186d8f3917da9c.min.css"
        />
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: 'window.gtmDataLayer = [{ page_category: "Explore Data Products" }];',
          }}
        />
        <script
          dangerouslySetInnerHTML={{
